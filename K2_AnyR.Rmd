...
# - ordering : vector of size n
#   Must contain a valid permutation of the integers [1, 2 ... n], representing the "prior" ordering of variables,
...
#TODO:
# - Optimize!
# - Add support for layered ordering (if ordering is a list use layers, if it is vector use current method)
